...
export const journalSlice = createSlice({
  ...
  reducers: {
    ...
    addNewEmptyNote: (state, action) => {
      // agregamos una nota al array de notas
    ...
    updateNote: (state, action) => { //payload: note
      ...
      // recibimos la nota y actualizamos la nota por el id
      state.isSaving = false;
    ...
    setPhotosToActiveNote: (state, action) => {
      // mantenemos las imagenes activas
    ...
    deleteNoteById: (state, action) => {
      state.active = null;
      // Devuelte todas las notas que no sea el mismo id
